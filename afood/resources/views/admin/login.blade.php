...
<head>
    ...
    <title>登录</title>  
    <link rel="stylesheet" href="{{asset('resources/views/css/pintuer.css')}}">
    <link rel="stylesheet" href="{{asset('resources/views/css/admin.css')}}">
    <script src="{{asset('resources/views/js/jquery.js')}}"></script>
    <script src="{{asset('resources/views/js/pintuer.js')}}"></script>  
</head>
<body>
<div class="bg"></div>
<div class="container">
